...
{
    public partial class Form1Query2 : Form
    {
        public Form1Query2()
        {
            InitializeComponent();
...
AND PartsVertexInfor.bridgeID = '";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
               ...
               if(textBox2 .Text != "") cmd += "INSERT INTO `bridge`.`partsvertexinfor` (`bridgeID`, `PartID`, `PartsVertexID`, `PartsVertexName`, `PartLongitude`, `PartLatitude`, `PartAltitude`) VALUES('" + textBox1.Text + "','" + textBox3.Text + "','" + textBox2 .Text + "','" + textBox7 .Text + "','" + float.Parse(textBox8 .Text) + "','" + float.Parse(textBox9 .Text) + "','" + float.Parse(textBox10.Text) + "');";
               if(textBox15.Text != "") cmd += "INSERT INTO `bridge`.`partsvertexinfor` (`bridgeID`, `PartID`, `PartsVertexID`, `PartsVertexName`, `PartLongitude`, `PartLatitude`, `PartAltitude`) VALUES('" + textBox1.Text + "','" + textBox3.Text + "','" + textBox15.Text + "','" + textBox14.Text + "','" + float.Parse(textBox13.Text) + "','" + float.Parse(textBox12.Text) + "','" + float.Parse(textBox11.Text) + "');";
               if(textBox20.Text != "") cmd += "INSERT INTO `bridge`.`partsvertexinfor` (`bridgeID`, `PartID`, `PartsVertexID`, `PartsVertexName`, `PartLongitude`, `PartLatitude`, `PartAltitude`) VALUES('" + textBox1.Text + "','" + textBox3.Text + "','" + textBox20.Text + "','" + textBox19.Text + "','" + float.Parse(textBox18.Text) + "','" + float.Parse(textBox17.Text) + "','" + float.Parse(textBox16.Text) + "');";
               if(textBox25.Text != "") cmd += "INSERT INTO `bridge`.`partsvertexinfor` (`bridgeID`, `PartID`, `PartsVertexID`, `PartsVertexName`, `PartLongitude`, `PartLatitude`, `PartAltitude`) VALUES('" + textBox1.Text + "','" + textBox3.Text + "','" + textBox25.Text + "','" + textBox24.Text + "','" + float.Parse(textBox23.Text) + "','" + float.Parse(textBox22.Text) + "','" + float.Parse(textBox21.Text) + "');";
               if(textBox30.Text != "") cmd += "INSERT INTO `bridge`.`partsvertexinfor` (`bridgeID`, `PartID`, `PartsVertexID`, `PartsVertexName`, `PartLongitude`, `PartLatitude`, `PartAltitude`) VALUES('" + textBox1.Text + "','" + textBox3.Text + "','" + textBox30.Text + "','" + textBox29.Text + "','" + float.Parse(textBox28.Text) + "','" + float.Parse(textBox27.Text) + "','" + float.Parse(textBox26.Text) + "');";
               if(textBox35.Text != "") cmd += "INSERT INTO `bridge`.`partsvertexinfor` (`bridgeID`, `PartID`, `PartsVertexID`, `PartsVertexName`, `PartLongitude`, `PartLatitude`, `PartAltitude`) VALUES('" + textBox1.Text + "','" + textBox3.Text + "','" + textBox35.Text + "','" + textBox34.Text + "','" + float.Parse(textBox33.Text) + "','" + float.Parse(textBox32.Text) + "','" + float.Parse(textBox31.Text) + "');";
               if(textBox40.Text != "") cmd += "INSERT INTO `bridge`.`partsvertexinfor` (`bridgeID`, `PartID`, `PartsVertexID`, `PartsVertexName`, `PartLongitude`, `PartLatitude`, `PartAltitude`) VALUES('" + textBox1.Text + "','" + textBox3.Text + "','" + textBox40.Text + "','" + textBox39.Text + "','" + float.Parse(textBox38.Text) + "','" + float.Parse(textBox37.Text) + "','" + float.Parse(textBox36.Text) + "');";
               if(textBox45.Text != "") cmd += "INSERT INTO `bridge`.`partsvertexinfor` (`bridgeID`, `PartID`, `PartsVertexID`, `PartsVertexName`, `PartLongitude`, `PartLatitude`, `PartAltitude`) VALUES('" + textBox1.Text + "','" + textBox3.Text + "','" + textBox45.Text + "','" + textBox44.Text + "','" + float.Parse(textBox43.Text) + "','" + float.Parse(textBox42.Text) + "','" + float.Parse(textBox41.Text) + "');";
                Debug.WriteLine(cmd);
                MySqlCommand mySqlCommand = CsharpMySQL.GetSqlCommand(cmd, mysql);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            if (textBox3.Text == "" || textBox3.Text == null)
            {
                MessageBox.Show(this, "部件编号不允许为空!", "删除失败"); return;
            }
            MySqlConnection mysql = CsharpMySQL.GetMySqlConnection();
            mysql.Open();
            string cmd = "DELETE FROM PartsInfor WHERE bridgeID = '" + textBox1.Text + "'AND PartID = '" + textBox3.Text + "';";
